...
import { ReactComponent as LogoDM } from "../../assets/images/logo-DM.svg";
import "./Footer.css";
      ...
      <div className="container-fluid  container-min-max-width">
        ...
        <div className="row ">
          <div className="footer-nav col-lg-6 col-12 d-flex justify-content-around my-3">
            ...
            <Link to="/about" className="footer-navbar-item">
              {" "}
              About us
            </Link>
            <Link to="/privacy-policy" className="footer-navbar-item">
              {" "}
              Privacy Policy
            </Link>
            ...
            <Link to="/contact" className="footer-navbar-item">
              {" "}
              Contact
            </Link>
          </div>
