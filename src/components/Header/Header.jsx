...
function Header(props) {
  const { numberOfProducts, user, signOutInjected, numberOfWishProducts } =
    props;
  // console.log(props);
      ...
      <div className="container-fluid container-min-max-width d-flex justify-content-center position-relative flex-column ">
        <div className=" d-flex justify-content-end ">
          <div>
            {user ? (
              <div>
                <p className="font-italic navbar-name ">
                ...
                <button
                  ...
                  className="btn navbar-item navbar-login-logout"
                >
                  Log out
                </button>
              </div>
            ) : (
              <Link to="/login" className="navbar-item navbar-login-logout">
                Login
              </Link>
            )}
          </div>
          <Link to="/wishlist" className="d-flex no-link ">
            ...
            <span className="ml-1 mr-3 number-cart-wish">
              {" "}
              {numberOfWishProducts}
            </span>
          </Link>
        ...
        <Navbar
          expand="md"
          variant="dark"
          className="p-0 d-flex justyfy-content-space-between"
        >
          ...
          >
            {" "}
            {/* colapseaza elementele maniului */}
            <Nav>
              <NavLink
                to="/"
                exact
