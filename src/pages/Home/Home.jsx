        ...
        <Layout>
          <div className="hero d-flex align-items-end ">
            <div className="container-fluid container-min-max-width mb-5">
              <div className="d-flex flex-column align-items-end pb-5">
                <p className="hero-sec">All for a special day</p>
                <h1 className="hero-h1">SWEETS</h1>
                <div className="small-line"></div>
                <p className="hero-p-descrip">
                  It’s always good time for sweets!
                  <br />
                  Find your favorite now.
                </p>
                {/* Scroll to the list of products with id="link-products" */}
                <Link
                  to="link-products"
                  smooth={true}
                  offset={-90}
          ...
          <div className="container-fluid container-min-max-width">
            <div className="title">
              ...
              <h2 className="title-h2 h1" id="link-products">
                our products
              </h2>
            </div>
            <div className="row">
