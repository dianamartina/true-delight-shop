  ...
  return (
    <Layout>
      <div className="cart container-fluid container-min-max-width ">
        <div className="row d-flex  justify-content-center pl-3 pr-1 cart-container">
          {
              ...
              <div className="w-100 mt-5 vh-50">
                ...
                </h5>
                {
                  ...
                  products.map((product) => {
                    return (
                      <div
                        className="d-flex justify-content-between align-items-center border-bottom pt-2 font-italic "
                        key={product.id}
                      >
                        ...
                        <div className="w-25 d-flex justify-content-center position-relative">
                          ...
                          <span
                            ...
                            className="delete cart-delete px-2"
                          >
                            <Delete />
                          </span>
                        </div>
                ...
                <div className="d-flex justify-content-end ">
                  <div className="w-25 d-flex align-items-center justify-content-center">
                    <h5 className="my-4 text-uppercase cart-table-title">
                      Total
                    </h5>
                  </div>
                  <div className="w-25">
