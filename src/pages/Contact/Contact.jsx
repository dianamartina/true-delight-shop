            ...
            <div className="container-fluid container-min-max-width">
                ...
                <div className="row text-left d-flex align-items-start">
                    ...
                    <div className="col-md-7 home-text px-3"> 
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste itaque impedit nostrum eveniet. Rem earum, eius eligendi cumque alias quis possimus consequatur. Nulla quaerat fugiat neque praesentium labore iste modi voluptates in enim 
                        </p>
